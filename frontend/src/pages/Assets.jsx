        ...
        <div className="bg-white rounded-lg shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
          <div className="p-6">
            <div className="flex justify-between items-start mb-4">
              <div>
                <h2 className="text-2xl font-bold text-gray-900">{asset.symbol}</h2>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="text-2xl font-bold text-gray-900">${asset.currentPrice.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600">Change</p>
                <p className={`text-2xl font-bold ${asset.changePercent >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                  {asset.changePercent >= 0 ? '+' : ''}{asset.changePercent.toFixed(2)}%
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600">Volume</p>
                <p className="text-xl font-semibold text-gray-900">{asset.volume.toLocaleString()}</p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600">Type</p>
                <p className="text-xl font-semibold text-gray-900 capitalize">{asset.type}</p>
              </div>
            </div>
            ...
            {asset.sector && (
              <div className="mb-4">
                ...
                <p className="text-lg font-semibold text-gray-900">{asset.sector}</p>
              </div>
            )}
