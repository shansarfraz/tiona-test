            ...
            return (
              <div key={index} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <span className={`px-3 py-1 text-xs font-medium rounded-full ml-4 whitespace-nowrap ${getCategoryColor(item.category)}`}>
                    {item.category}
                  </span>
                </div>
                ...
                {item.affectedAssets && item.affectedAssets.length > 0 && (
                  <div className="mt-4 pt-4 border-t border-gray-200">
                    <p className="text-sm text-gray-600 mb-2">Affected Assets:</p>
